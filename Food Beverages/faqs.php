...
<body>
    ...
    <div class="faq-section pt-100 pb-70 bg-overlay-2">
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="faq-accordion">
                        ...
                        <div class="faq-accordion-item faq-accordion-item-bgless faq-accordion-item-active">
                            <div class="faq-accordion-header">
                                <h3 class="faq-accordion-title">How is Collective Food different to others?</h3>
                            </div>
                            <div class="faq-accordion-body">
                                <div class="faq-accordion-body-inner p-30">
                        ...
                        <div class="faq-accordion-item faq-accordion-item-bgless">
                            <div class="faq-accordion-header">
                                <h3 class="faq-accordion-title">How does the service work exactly?</h3>
                            </div>
                            <div class="faq-accordion-body">
                                <div class="faq-accordion-body-inner p-30">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                        ...
                        <div class="faq-accordion-item faq-accordion-item-bgless">
                            <div class="faq-accordion-header">
                                <h3 class="faq-accordion-title">How do you make your money?</h3>
                            </div>
                            <div class="faq-accordion-body">
                                <div class="faq-accordion-body-inner p-30">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                        ...
                        <div class="faq-accordion-item faq-accordion-item-bgless">
                            <div class="faq-accordion-header">
                                <h3 class="faq-accordion-title">What kind of foods can I order?</h3>
                            </div>
                            <div class="faq-accordion-body">
                                <div class="faq-accordion-body-inner p-30">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                <div class="col-sm-12 col-md-6 pb-30">
                    <div class="personalized-item text-center text-lg-start">
                        <img src="assets/images/header-3-carousel-1.png" alt="personalized item">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12 col-lg-5 pb-30">
                    <div class="about-content section-title text-center text-lg-end m-0">
                        ...
                        <p>We are the country's no.1 Fast food retailer with 15+ years of reputation. Country's best
                            Thali and Items are delivered by us. We gain the satisfaction of our customers with our
    ...
    <section class="gallery-section p-tb-100 bg-black">
        <div class="container position-relative">
            ...
            <div class="gallery-grid">
                ...
                <div class="gallery-grid-item">
                    <a href="assets/images/gallery-lg-5.jfif" title="Gallery 5"><img src="assets/images/gallery-5.jfif"
                            alt="gallery"></a>
                </div>
            </div>
            <div class="bg-shape">
