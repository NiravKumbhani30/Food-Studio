            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 pb-30 blog-grid-item">
                    <div class="blog-card blog-card-maincolor">
                        ...
                        <div class="blog-card-content">
                            <ul class="blog-entry">
                                <li><i class="flaticon-calendar-1"></i>10 Oct 2020</li>
                                <li><i class="flaticon-man-user"></i>By Admin</li>
                            </ul>
                            <h3><a href="blog-details.html">How Combo Offer Can Save Our Money And Time</a></h3>
                            <p>This Mexican Style Burger is pumped out with flavor</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 pb-30 blog-grid-item">
                    <div class="blog-card blog-card-maincolor">
                        ...
                        <div class="blog-card-content">
                            <ul class="blog-entry">
                                <li><i class="flaticon-calendar-1"></i>9 Oct 2020</li>
                                <li><i class="flaticon-man-user"></i>By Admin</li>
                            </ul>
                            <h3><a href="blog-details.html">Which Secret Recipe Make A Burger Extra Ordinary</a></h3>
                            <p>This Mexican Style Burger is pumped out with flavor</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 pb-30 blog-grid-item">
                    <div class="blog-card blog-card-maincolor">
                        ...
                        <div class="blog-card-content">
                            <ul class="blog-entry">
                                <li><i class="flaticon-calendar-1"></i>8 Oct 2020</li>
                                <li><i class="flaticon-man-user"></i>By Admin</li>
                            </ul>
                            <h3><a href="blog-details.html">How can Pizza's Taste Can Defeat Burger's Taste</a></h3>
                            <p>This Mexican Style Burger is pumped out with flavor</p>
                        </div>
                    </div>
                </div>
