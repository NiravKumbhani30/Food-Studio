...
if($_REQUEST['id']!="")
{
    ...
    header('location:fixthalidetails.php');
}
$temp=$_SESSION["proid"];
$data=$con->query("select * from fixthali where fixthaliid=$temp");
$row=mysqli_fetch_array($data);

$_SESSION['fixthaliid'] = $row[0];
...
if(isset($_REQUEST['reviewfixthali']))
{
    ...
    $data=$con->query("select * from fixthali_review where userid like '$_SESSION[userid]' and fixthaliid=$_SESSION[proid]");
    $row=mysqli_fetch_array($data);
   
    if($row[0]=="")
    {
    $in=$con->query("insert into fixthali_review value('$_SESSION[userid]','$_SESSION[proid]',0,'$ireviewdate','$_REQUEST[reviewtext]')");
    header('location:fixthalidetails.php');
    }
    else
    {
...
{
    $in=$con->query("insert into cart value('$_SESSION[userid]','$_SESSION[fixthaliid]',0,0,'$_SESSION[amount]',0,'$_SESSION[amount]')");
    //echo "insert into cart value('$_SESSION[userid]','$_SESSION[fixthaliid]',0,0,'$_SESSION[amount]',0,'$_SESSION[amount]')";
                ...
                <div class="header-page-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Fixthali Detail</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="product-details-section pt-100 pb-70 bg-black">
        <div class="container">
                        ...
                        <div class="product-details-slider">
                            <div class="product-details-for popup-gallery">
                                <div class="product-for-item">
                                    <a href="<?php echo $row[2] ;?>"><img style="height: 360px;width: 464px;border-radius: 10px;background-size: cover;" src="<?php echo $row[2] ;?>"
                                            alt="product"></a>
                                </div>
                    ...
                    <div class="product-details-item">
                        <div class="product-details-caption">
                            ...
                            <div class="product-details-price mb-20">
                                <h4 style="color: #fc0;">PRICE :&nbsp;<i class="fas fa-rupee-sign"></i>&nbsp;<?php echo $row[3]; ?></h4>
                            </div>
                            <div class="review-star mb-20">
                                        ...
                                        <a style="height: 10px; margin-left: 20px; padding: 14px 14px" class="btn btn-yellow" data-toggle="modal" data-target="#rateus"
                                            onclick="forrate('rate',<?php echo $_SESSION['proid']; ?>,'<?php echo $_SESSION['userid']; ?>',0);">Rate
                                            Us</a>
                                        <?php
                                            }
                                        ?>
            ...
            <div class="product-details-tab below-border">
                ...
                <div class="product-tab-information">
                    ...
                    <div class="product-tab-information-item" data-product-details-tab="2">
                        ...
                        <?php
                        $rdata = $con->query("select i.*,r.* from fixthali_review as i,register as r  where i.userid=r.userid and  i.fixthaliid=$_SESSION[proid]  ORDER by reviewid desc limit 4");
                                    ...
                                    <div class="carousel-info text-end">
                                        <div class="review-star">
                                            <ul class="justify-content-end">
                                                <?php
                                            $data1=$con->query("select * from fixthali_rate where userid like '$_SESSION[userid]' and fixthaliid like '$_SESSION[proid]'");
                                        ...
                                        <h3 class="carousel-name" style="text-transform: capitalize;">
                                            <?php echo $rrow[8]." ".$rrow[9]; ?></h3>
                                ...
                                <div class="comment-input-area">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group mb-20">
                                                <div class="input-group">
                                                    <textarea name="reviewtext" class="form-control" id="message" rows="5"
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            {
                                            ?>
                                                <button class="btn full-width" name="reviewfixthali">Post Your Review</button>
                                            <?php
                                            }
                                            ?>
                                        </div>
            ...
            <div class="related-product mt-50">
                ...
                <?php 
                    $data3=$con->query("select i.*, a.* from item as i, fixthaliitemassign as a where a.fixthaliid=$_SESSION[proid] and a.itemid=i.itemid");
                    ...
                    <div class="receipe-item receipe-item-black pb-30">
                        <div class="receipe-item-inner">
                            <div class="receipe-image">
                                <img src="<?php echo $row2[3]; ?>" style="height: 90px;width: 90px;border-radius: 50%;background-size: cover;" alt="receipe">
                            </div>
                            <div class="receipe-content">
                                <div class="receipe-info">
                                    <h3><a href="allitem.php"><?php echo $row2[2]; ?></a></h3>
                                    <h4><i class="fas fa-rupee-sign"></i>&nbsp;<?php echo $row2[4]; ?></h4>
                                </div>
