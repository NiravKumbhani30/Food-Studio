...
<body>
    ...
    <div class="header-bg header-bg-page" id="policy">
    ...
    <section class="privacy-page-section p-tb-100 bg-black">
        <div class="container">
                ...
                <ul class="terms-privacy-list">
                    <li>
                        <p><strong>01.</strong>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab, tempora
                            ...
                            adipisicing elit. Voluptates nulla porro commodi.</p>
                    </li>
                    <li>
